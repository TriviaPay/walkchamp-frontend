...
/// Widget Extension entry for Walk Champ race Live Activities.
/// Add this file to a Widget Extension target in Xcode (File → New → Target → Widget Extension).
/// Copy into a Widget Extension target in Xcode — do not compile @main in the app target.
@available(iOS 16.2, *)
