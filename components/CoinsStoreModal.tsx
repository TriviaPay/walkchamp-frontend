...
function ThemeCard({ theme, onUnlock, onEquip }: {
  ...
  const tc = {
    ...
    equippedTxt:    { fontSize: rf(9), fontWeight: "800" as const, color: "#fff" },
    ownedBadge:     { backgroundColor: "#14532D", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, alignSelf: "flex-end" as const },
    ownedTxt:       { fontSize: rf(9), fontWeight: "800" as const, color: "#4ADE80" },
    body:           { padding: 8 },
    name:           { fontSize: rf(12), fontWeight: "700" as const, color: c.foreground, marginBottom: 6 },
    ...
    priceNum:       { fontSize: rf(11), fontWeight: "700" as const, color: "#FFD700" },
    ...
    actionTxt:      { fontSize: rf(10), fontWeight: "800" as const, color: "#fff" },
    actionTxtDim:   { color: c.mutedForeground },
    useTxt:         { fontSize: rf(10), fontWeight: "800" as const, color: "#000" },
    ...
    selectedTxt:    { fontSize: rf(10), fontWeight: "700" as const, color: "#A855F7" },
  };
...
function makeStoreStyles(c: ReturnType<typeof useColors>) {
  return {
    ...
    tabTxt:         { fontSize: rf(13), fontWeight: "600" as const, color: c.mutedForeground },
    ...
    balanceLabel:   { flex: 1, fontSize: rf(13), color: c.mutedForeground },
    balanceValue:   { fontSize: rf(20), fontWeight: "900" as const, color: "#FFD700" },
    ...
    sectionLabel:   { fontSize: rf(11), fontWeight: "700" as const, letterSpacing: 1.1, color: c.mutedForeground, marginBottom: 12 },
    iapLoadingRow:  { flexDirection: "row" as const, alignItems: "center" as const, gap: 10, paddingVertical: 12 },
    iapLoadingTxt:  { fontSize: rf(13), color: c.mutedForeground },
    ...
    iapErrorTxt:    { fontSize: rf(13), color: "#F87171", textAlign: "center" as const },
    retryBtn:       { backgroundColor: "#7C3AED", paddingHorizontal: 20, paddingVertical: 9, borderRadius: 10 },
    retryTxt:       { fontSize: rf(13), fontWeight: "700" as const, color: "#fff" },
    ...
    packCoins:      { fontSize: rf(17), fontWeight: "800" as const, color: "#FFD700" },
    packSub:        { fontSize: rf(11), color: c.mutedForeground },
    ...
    packBadgeText:  { fontSize: rf(10), fontWeight: "800" as const, letterSpacing: 0.3 },
    ...
    priceBtnText:   { fontSize: rf(14), fontWeight: "900" as const, color: "#000" },
    ...
    freeTitle:      { fontSize: rf(15), fontWeight: "700" as const, color: "#22C55E" },
    freeSub:        { fontSize: rf(12), color: c.mutedForeground, lineHeight: 17 },
    ...
    themesCount:    { fontSize: rf(12), color: c.mutedForeground },
    ...
    loadingTxt:     { fontSize: rf(14), color: c.mutedForeground, marginTop: 4 },
    errorTxt:       { fontSize: rf(15), fontWeight: "600" as const, color: "#EF4444" },
    errorHint:      { fontSize: rf(13), color: c.mutedForeground },
    allOwnedTxt:    { fontSize: rf(15), fontWeight: "700" as const, color: "#22C55E", textAlign: "center" as const },
    ...
    micDiscText:    { color: "#fff", fontSize: rf(11), fontWeight: "900" as const, letterSpacing: 0.5 },
    ...
    micTitle:       { fontSize: rf(18), fontWeight: "800" as const, color: c.foreground },
    micSub:         { fontSize: rf(13), color: "#C4B5FD" },
    micPromo:       { fontSize: rf(11), color: "#A78BFA", fontWeight: "700" as const },
    micRight:       { alignItems: "flex-end" as const, gap: 4 },
    micPriceCol:    { alignItems: "flex-end" as const, gap: 6 },
    micOldPrice:    { fontSize: rf(13), color: c.mutedForeground, textDecorationLine: "line-through" as const },
    ...
    micBuyText:     { color: "#fff", fontSize: rf(15), fontWeight: "900" as const },
    ...
    statsBannerNum:     { fontSize: rf(18), fontWeight: "900" as const, color: "#FFD700" },
    statsBannerLabel:   { fontSize: rf(11), color: c.mutedForeground },
    ...
    historyLoadingTxt: { fontSize: rf(12), color: c.mutedForeground },
    ...
    historyName:       { fontSize: rf(13), fontWeight: "700" as const, color: c.foreground },
    historyDate:       { fontSize: rf(11), color: c.mutedForeground },
    historyCoinsRow:   { flexDirection: "row" as const, alignItems: "center" as const, gap: 4 },
    historyCoinsText:  { fontSize: rf(13), fontWeight: "800" as const, color: "#FFD700" },
    historyMicBadge:   { backgroundColor: "#2D1064", paddingHorizontal: 7, paddingVertical: 3, borderRadius: 7 },
    historyMicBadgeTxt:{ fontSize: rf(10), fontWeight: "800" as const, color: "#A855F7" },
    historyEmpty:      { alignItems: "center" as const, gap: 6, paddingVertical: 20 },
    historyEmptyTxt:   { fontSize: rf(12), color: c.mutedForeground },
  };
}
