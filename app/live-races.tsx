...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: rf(12), marginTop: 1 },
  ...
  countLabel: { paddingHorizontal: 16, paddingBottom: 4, fontSize: rf(12) },
  emptyText: { textAlign: "center", marginTop: 40, fontSize: rf(14) },
  ...
  watchBtnText: { fontSize: rf(15), fontWeight: "800", color: "#000" },
});
