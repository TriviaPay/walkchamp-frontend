 ...
 * Available without requiring an authenticated session so store listings and
 * in-app access can share the same non-geofenced policy surface.
 */
export default function LegalScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <PrivacyPolicyDocument contentBottomPad={safeBottom + 36} />
    </View>
  );
}
