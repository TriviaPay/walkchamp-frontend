export type PrivacyPolicySection = {
  ...
  number: number;
  title: string;
  /** Full section body. Blank lines separate paragraphs; lines starting with • are bullets. */
  body: string;
};

export const PRIVACY_POLICY_TITLE = "WALK CHAMP PRIVACY POLICY";
export const PRIVACY_POLICY_LAST_UPDATED = "July 21, 2026";
export const PRIVACY_POLICY_SUPPORT_EMAIL = "admin@miragaming.com";
export const PRIVACY_POLICY_PUBLIC_URL = "https://walkchamp.app/legal";
...
• Reporting discrepancies promptly`,
  ...
  {
    id: "10-challenge-and-race-information",
    number: 10,
...
Other users may capture, copy, save, or re-share information that is visible to them. We cannot guarantee how another user will handle information you voluntarily make public.`,
  ...
  {
    id: "12-groups-friends-and-social-information",
    number: 12,
...
We use this information to operate social features, display leaderboards, provide communications, and enforce community standards.`,
  ...
  {
    id: "13-chat-messages-cheers-and-community-content",
    number: 13,
...
Where feasible, we use the least precise location sufficient for the feature.`,
  ...
  {
    id: "16-device-technical-and-usage-information",
    number: 16,
...
Razorpay's services may not be available for every user, country, or transaction.`,
  ...
  {
    id: "20-wallet-transaction-refund-and-payout-information",
    number: 20,
...
We may require identity, age, tax, address, location, or payout verification before releasing cash winnings.`,
  ...
  {
    id: "21-identity-age-kyc-tax-and-compliance-information",
    number: 21,
...
We may retain verification status, provider reference, result, and limited compliance records.`,
  ...
  {
    id: "22-referral-and-invite-information",
    number: 22,
...
• Protect users, Mira Gaming, and the public`,
  ...
  {
    id: "27-health-data-use-restrictions",
    number: 27,
...
You can opt out of marketing communications while continuing to receive necessary service and security notices.`,
  ...
  {
    id: "29-fraud-prevention-and-fair-play",
    number: 29,
...
Automated flags do not necessarily mean wrongdoing has occurred.`,
  ...
  {
    id: "31-legal-bases-for-processing",
    number: 31,
...
Security, fraud prevention, product improvement, service analytics, dispute resolution, and protection of our users and business.`,
  ...
  {
    id: "32-when-we-share-information",
    number: 32,
...
India Privacy Request`,
  ...
  {
    id: "44-european-economic-area-united-kingdom-and-switzerland",
    number: 44,
...
Where we rely on consent, you may withdraw it at any time.`,
  ...
  {
    id: "45-california-privacy-notice",
    number: 45,
...
• Security and fraud-prevention systems`,
  ...
  {
    id: "47-other-united-states-privacy-rights",
    number: 47,
...
US State Privacy Request`,
  ...
  {
    id: "48-children-and-age-restrictions",
    number: 48,
...
Where required, we will provide notice before information becomes subject to materially different privacy terms.`,
  ...
  {
    id: "52-changes-to-this-privacy-policy",
    number: 52,
...
If translations conflict, the legally designated controlling version will apply, subject to applicable consumer law.`,
  ...
  {
    id: "54-grievance-and-privacy-contact",
    number: 54,
...
export function searchPrivacyPolicySections(query: string): PrivacyPolicySection[] {
  const q = query.trim().toLowerCase();
  if (!q) return PRIVACY_POLICY_SECTIONS;
  return PRIVACY_POLICY_SECTIONS.filter((section) => {
    const haystack = `${section.number} ${section.title} ${section.body}`.toLowerCase();
